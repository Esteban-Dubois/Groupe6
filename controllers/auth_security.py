...
def auth_signup_post():
    ...
    sql = " SELECT * FROM utilisateur WHERE utilisateur.login = %s OR utilisateur.email = %s; "
    ...
    sql = "  INSERT INTO utilisateur (login,email,password,role,est_actif) VALUES (%s,%s,%s,%s,1);  "
